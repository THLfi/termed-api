...
CREATE INDEX scheme_role_scheme_id_idx ON scheme_role(scheme_id);
...
CREATE INDEX user_scheme_role_username_idx ON user_scheme_role(username);
...
CREATE INDEX scheme_permission_scheme_id_idx ON scheme_permission(scheme_id);
