...
CREATE TABLE scheme_property_value (
  ...
  CONSTRAINT scheme_property_value_scheme_id_fkey
    FOREIGN KEY (scheme_id) REFERENCES scheme(id) ON DELETE CASCADE,
  CONSTRAINT scheme_property_value_property_id_fkey
...
CREATE TABLE class_property_value (
  ...
  lang varchar(2) NOT NULL,
  value text NOT NULL,
  CONSTRAINT class_property_value_pkey
    PRIMARY KEY (class_scheme_id, class_id, property_id, index),
  CONSTRAINT class_property_value_class_scheme_id_class_id_fkey
    FOREIGN KEY (class_scheme_id, class_id)
    REFERENCES class(scheme_id, id) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT class_property_value_property_id_fkey
    FOREIGN KEY (property_id) REFERENCES property(id),
...
CREATE TABLE text_attribute (
  ...
  CONSTRAINT text_attribute_domain_fkey
    FOREIGN KEY (scheme_id, domain_id)
    REFERENCES class(scheme_id, id) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE INDEX text_attribute_scheme_id_idx
    ON text_attribute(scheme_id);
CREATE INDEX text_attribute_class_id_idx
    ON text_attribute(scheme_id, domain_id);
...
CREATE TABLE text_attribute_property_value (
  ...
  CONSTRAINT text_attribute_property_value_subject_fkey
    FOREIGN KEY (text_attribute_scheme_id, text_attribute_domain_id, text_attribute_id)
    REFERENCES text_attribute(scheme_id, domain_id, id) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE INDEX text_attribute_property_value_subject_id_idx
    ON text_attribute_property_value(text_attribute_scheme_id, text_attribute_domain_id, text_attribute_id);
...
CREATE TABLE reference_attribute (
  ...
  CONSTRAINT reference_attribute_range_fkey
    FOREIGN KEY (range_scheme_id, range_id)
    REFERENCES class(scheme_id, id) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE INDEX reference_attribute_scheme_id_idx
    ON reference_attribute(scheme_id);
CREATE INDEX reference_attribute_class_id_idx
    ON reference_attribute(scheme_id, domain_id);
...
CREATE TABLE reference_attribute_property_value (
  ...
  CONSTRAINT reference_attribute_property_value_pkey
    PRIMARY KEY (reference_attribute_scheme_id, reference_attribute_domain_id, reference_attribute_id, property_id, index),
  CONSTRAINT reference_attribute_property_value_subject_fkey
    FOREIGN KEY (reference_attribute_scheme_id, reference_attribute_domain_id, reference_attribute_id)
    REFERENCES reference_attribute(scheme_id, domain_id, id) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE INDEX reference_attribute_property_value_subject_id_idx
    ON reference_attribute_property_value(reference_attribute_scheme_id, reference_attribute_domain_id, reference_attribute_id);
...
CREATE TABLE resource (
  ...
  CONSTRAINT resource_type_fkey FOREIGN KEY (scheme_id, type_id) REFERENCES class(scheme_id, id) ON UPDATE CASCADE,
...
CREATE INDEX resource_scheme_id_idx
    ON resource(scheme_id);
CREATE INDEX resource_scheme_id_type_id_idx
    ON resource(scheme_id, type_id);
...
CREATE TABLE resource_text_attribute_value (
  ...
  value text NOT NULL,
  regex varchar(255) NOT NULL,
  CONSTRAINT resource_text_attribute_value_pkey
    PRIMARY KEY (scheme_id, resource_type_id, resource_id, attribute_id, index),
  CONSTRAINT resource_text_attribute_value_resource_fkey
    FOREIGN KEY (scheme_id, resource_type_id, resource_id)
    REFERENCES resource(scheme_id, type_id, id) ON DELETE CASCADE,
  CONSTRAINT resource_text_attribute_value_attribute_fkey
    FOREIGN KEY (scheme_id, resource_type_id, regex, attribute_id)
    REFERENCES text_attribute(scheme_id, domain_id, regex, id) ON UPDATE CASCADE,
...
CREATE INDEX resource_text_attribute_value_resource_idx
    ON resource_text_attribute_value(scheme_id, resource_type_id, resource_id);
...
CREATE TABLE resource_reference_attribute_value (
  ...
  CONSTRAINT resource_reference_attribute_value_pkey
    PRIMARY KEY (scheme_id, resource_type_id, resource_id, attribute_id, index),
  CONSTRAINT resource_reference_attribute_value_resource_fkey
    FOREIGN KEY (scheme_id, resource_type_id, resource_id)
    REFERENCES resource(scheme_id, type_id, id) ON DELETE CASCADE,
  CONSTRAINT resource_reference_attribute_value_attribute_fkey
    FOREIGN KEY (scheme_id, resource_type_id, value_scheme_id, value_type_id, attribute_id)
    REFERENCES reference_attribute(scheme_id, domain_id, range_scheme_id, range_id, id) ON UPDATE CASCADE,
  CONSTRAINT resource_reference_attribute_value_value_fkey
    FOREIGN KEY (value_scheme_id, value_type_id, value_id)
    REFERENCES resource(scheme_id, type_id, id) ON DELETE CASCADE
);

CREATE INDEX resource_reference_attribute_value_resource_idx
    ON resource_reference_attribute_value(scheme_id, resource_type_id, resource_id);
CREATE INDEX resource_reference_attribute_value_value_idx
    ON resource_reference_attribute_value(value_scheme_id, value_type_id, value_id);
