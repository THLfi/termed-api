...
CREATE TABLE text_attribute_permission (
  ...
  CONSTRAINT text_attribute_permission_pkey
    PRIMARY KEY (text_attribute_graph_id, text_attribute_domain_id, text_attribute_id, role, permission),
  ...
  CONSTRAINT text_attribute_permission_graph_role_fkey
    FOREIGN KEY (text_attribute_graph_id, role)
    REFERENCES graph_role(graph_id, role) ON DELETE CASCADE,
...
CREATE INDEX text_attribute_permission_attribute_idx
    ON text_attribute_permission(text_attribute_graph_id, text_attribute_domain_id, text_attribute_id);
...
CREATE TABLE reference_attribute_permission (
  ...
  CONSTRAINT reference_attribute_permission_pkey
    PRIMARY KEY (reference_attribute_graph_id, reference_attribute_domain_id, reference_attribute_id, role, permission),
  ...
  CONSTRAINT reference_attribute_permission_graph_role_fkey
    FOREIGN KEY (reference_attribute_graph_id, role)
    REFERENCES graph_role(graph_id, role) ON DELETE CASCADE,
...
CREATE INDEX reference_attribute_permission_attribute_idx
    ON reference_attribute_permission(reference_attribute_graph_id, reference_attribute_domain_id, reference_attribute_id);
