...
public class JdbcClassPropertyValueDao extends AbstractJdbcDao<PropertyValueId<ClassId>, LangValue> {
  ...
  protected RowMapper<PropertyValueId<ClassId>> buildKeyMapper() {
    return (rs, rowNum) -> new PropertyValueId<>(
        new ClassId(rs.getString("class_id"), UUIDs.fromString(rs.getString("class_scheme_id"))
        ),
