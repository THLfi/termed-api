...
public class JdbcPostgresNodeReferenceAttributeValueDao extends
  ...
  @Override
  public void insert(Map<NodeAttributeValueId, NodeId> map) {
  ...
  private void copyIn(BaseConnection c, Map<NodeAttributeValueId, NodeId> map) {
    String sql = "COPY node_reference_attribute_value FROM STDIN CSV";
    int batchSize = 10000;
