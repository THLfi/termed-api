...
public class GetResourceReferences implements LuceneSpecification<ResourceId, Resource> {

  private ResourceId subjectId;
  private ReferenceAttributeId attrId;
  private ClassId rangeId;

  public GetResourceReferences(ResourceId subjectId, ReferenceAttributeId attrId, ClassId rangeId) {
  ...
  public boolean equals(Object o) {
    ...
    GetResourceReferences that = (GetResourceReferences) o;
