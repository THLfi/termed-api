 ...
 */
public class NodeDtoRdfMessageConverter extends AbstractGenericHttpMessageConverter<List<NodeDto>> {

  private Type nodeDtoListType = new TypeToken<List<NodeDto>>() {
  }.getType();

  public NodeDtoRdfMessageConverter() {
    super(MediaType.valueOf("application/n-triples;charset=UTF-8"),
          MediaType.valueOf("application/rdf+xml;charset=UTF-8"),
          MediaType.valueOf("application/ld+json;charset=UTF-8"),
          MediaType.valueOf("text/turtle;charset=UTF-8"),
          MediaType.valueOf("text/n3;charset=UTF-8"));
  }
